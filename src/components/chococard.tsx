...
export const TripCards = () => {
    return (
      <View
        ...
        className="aspect-[353/133] bg-[#8C5A2B] rounded-lg px-0 py-2 flex justify-between relative"
      >
        {/* Background Images */}
        <Image
          source={require("@/assets/images/EllipseChoco1.png")}
          className="absolute top-0 left-0 w-[110px] h-[99px] opacity-100 rounded-lg"
          contentFit="cover"
        />
        <Image
          source={require("@/assets/images/EllipseChoco2.png")}
