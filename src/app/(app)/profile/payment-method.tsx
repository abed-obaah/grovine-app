    ...
    <ScreenLayout useStaticView backgroundColor="#FDFDFD">
      <View className="pt-[20px]">
        ...
        >
          ...
          <Pressable
            onPress={() => router.navigate("profile/add-payment")}
            className="absolute right-[16px] flex-row items-center gap-[5px]"
          >
            <FontAwesome6 name="add" size={20} color="#5554ED" />

            <Text className="text-sm text-primary font-gilroyMedium">Add</Text>
          </Pressable>
        </View>
      </View>
